...
**Опр** Пусть $G:K\to\lbrace 0,1 \rbrace ^n$ - называется безопасным, если нет статистического теста, который отличает 

if $\forall$ эффективного статистического теста $A$ $Adv_{PRG}[A,G]<\Epsilon<\dfrac{1}{2^{30}}$

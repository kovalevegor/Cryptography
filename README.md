...
Безопасный шифр текст - если, вероятностные распределения двух шифр текстов приблизительно равны 

+ Оракул $\square$ - тот кто знает решение, но ты у него можешь спросить правильно/неправильно
+ $k \in K$
+ Оракул придумал себе число b = {0, 1}
...
$ if \space Adv_{PRG} [A,E]->0$ - противник слабый
$ if \space Adv_{PRG} [A,E]->1$ - притивник сильный 

**Определение** *Потоковый шифр Е называется семантически стойкимесли, для любого эффективного противника А значение его эффективности к этому шифру меньше эпсилон, где эпсилон число не значимое*

**Определение** *Точность определения*

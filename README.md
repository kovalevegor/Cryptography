...
Так как каждое слово образуется из 16 возможных вариантов, то общая вероятность выпадения благоприятного исхода $\dfrac{1}{16}$, а вероятность удовлетворяющая условиям должна быть близка к $\dfrac{1}{2}$
